	...
	const allProjects = [
		{
			...
			number: '01.',
			title: 'Nymara',
			subtitle: 'A modern e-commerce platform for a lab-grown diamond brand, designed to deliver a luxury shopping experience with seamless navigation, product discovery, and secure checkout.',
			video: vid1,
		},
		{
			id: 2,
			...
			subtitle: ' A clean and informative school website designed to showcase academics, admissions, and campus life with an intuitive and user-friendly interface.',
			video: vid2,
		},
		{
			id: 3,
			number: '03.',
			title: 'IB Tech',
			subtitle: 'A professional website for a Chartered Accountant firm, built to establish trust, showcase services, and enable easy client inquiries.',
			video: vid3,
		},
	];
