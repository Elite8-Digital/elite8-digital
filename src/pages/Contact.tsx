							...
							<div className="mt-12">
								...
								<div className="flex space-x-4">
									...
									<a
										...
										className="group w-10 h-10 rounded-full bg-[#000000] flex items-center justify-center hover:bg-[#E4405F]/20 transition-colors"
									>
										<svg
											xmlns="http://www.w3.org/2000/svg"
											viewBox="0 0 24 24"
						...
						<div className="reveal" ref={(el) => (revealRefs.current[1] = el)}>
							...
							>
								<form
									...
									className="p-8 rounded-lg border border-white/10 bg-secondary/50 backdrop-blur-sm relative z-10"
								>
									{submitSuccess ? (
