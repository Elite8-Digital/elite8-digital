            ...
            >
              ...
              <div className="mt-12">
                ...
                <div className="flex space-x-4">
                  { <a href="https://www.instagram.com/elite8digital/?hl=en" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-secondary flex items-center justify-center hover:bg-primary/20 transition-colors">
